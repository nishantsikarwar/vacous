...
import com.google.android.apps.comflu18.animations.BugDroid;
import com.google.android.apps.comflu18.fragments.ListingFragment;
import com.google.android.apps.comflu18.network.TSVRequest;
import com.google.android.apps.comflu18.network.VolleySingleton;
import com.google.android.apps.comflu18.objects.Conference;
import com.google.android.apps.comflu18.objects.ConferenceDay;
import com.google.android.apps.comflu18.utils.PreferenceManager;
import com.google.android.apps.comflu18.utils.SendNotification;
...
public class MainActivity extends AppCompatActivity
    ...
    public static final String URL = "https://docs.google.com/spreadsheets/d/1VwO7aHLdKpNbZl7eA3oAxHbmlIuv1wdyH7qrFurKOHk/pub?gid=0&single=true&output=tsv";
    ...
    private void setupViewPager(Bundle savedInstanceState) {
        ...
        ConferenceDay day1 = new ConferenceDay(1, "12/6/2018");
        ConferenceDay day2 = new ConferenceDay(2, "12/7/2018");
        ConferenceDay day3 = new ConferenceDay(3, "12/8/2018");
        ConferenceDay day4 = new ConferenceDay(4, "12/9/2018");
        ...
        mAdapter.addFragment(ListingFragment.newInstance(mConferences, day3), getString(R.string.day, 3));
        mAdapter.addFragment(ListingFragment.newInstance(mConferences, day4), getString(R.string.day, 4));
