    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewHolderHeader) {
            ...
            if (mData.get(position).getHeadeline().equals(mContext.getString(R.string.coffee_break))) {
                ...
                ((ViewHolderHeader)holder).iconHeader.setImageResource(R.mipmap.coffee);
                ...
                ((ViewHolderHeader)holder).iconHeader.setImageResource(R.mipmap.toast);
                ...
                ((ViewHolderHeader)holder).iconHeader.setImageResource(R.mipmap.microphone);
            }
            ...
            if (mData.get(position).isFavorite(mContext)) {
                ...
                ((ViewHolderConference)holder).favorite
                        .setImageResource(R.mipmap.ic_favorite_grey600_18dp);
            } else {
